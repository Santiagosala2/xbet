    ...
    return (
        <div>
            ...
            <div className="flex-auto  border rounded-md  border-slate-300 p-1 ">
                {!renderSelectedValue ?
                    <button type="button" onClick={btnOnClick ? () => btnOnClick(name) : btnOnClick} className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-1 bg-slate-900 hover:text-white border-gray-600 hover:bg-slate-900 hover:border-gray-600">Add {emoji}</button>
                    :
                    <div className="text-gray-900 bg-white border border-gray-300 focus:outline-none font-medium rounded-lg text-sm px-5 py-1 bg-slate-900 border-gray-600 w-fit">{value}
