...
function App(_a) {
    ...
    var authCheck = function (url) { return __awaiter(_this, void 0, void 0, function () {
        var response, finalResponse, publicPaths;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/auth", {
                        method: "POST"
                    })];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    if (!finalResponse.result && !publicPaths.includes(url)) {
                        return [2 /*return*/, router.push('/login')];
                    }
                    return [2 /*return*/];
            }
        });
